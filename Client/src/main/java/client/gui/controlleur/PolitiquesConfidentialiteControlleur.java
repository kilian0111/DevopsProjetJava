...
public class PolitiquesConfidentialiteControlleur implements Initializable,Icontrolleur {

    private Client client;

    @FXML
    private TextFlow txtPolitiqueConf;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        txtPolitiqueConf.getChildren().add(lesConditions);
    }
